    ...
    <div class="modal-container">
        <div class="modal-body">
            <div class="modal-agree-block modal-agree-block--active">
                ...
                <span class="modal-title">Вимоги щодо застосування торговельної марки «Зроблено в Україні»</span>
                <p class="modal-text">Даною торговельною маркою маркуються товари на первинній тарі (упаковці) яких
                    зазначено про фактичне місцезнаходження виробничих потужностей виробника цього товару на
                    території України.</p>
                <p class="modal-text">Використання товарного знаку виробниками машин та обладнання, а також
                    автомобільної та мототранспортної техніки дозволяється якщо фактичне місцезнаходження виробничих
                    потужностей виробника цього товару знаходиться на території України про  що зазначено в
                    технічній документації на товар.</p>
                <p class="modal-text">Торговою маркою «Зроблено в Україні» не можуть бути марковані товари виробники
                    та повʼязані з ними особи, які: провадять господарську діяльність на території Російської
                    Федерації та Республіки Білорусь; які віднесені до юридичних або фізичних осіб, до яких
                    застосовуються спеціальні економічні та інші обмежувальні заходи (санкції) відповідними
                    рішеннями Ради національної безпеки і оборони України, введеними в дію указами Президента
                    України щодо застосування персональних (спеціальних) економічних та інших обмежувальних заходів
                    (санкцій) відповідно до Закону України “Про санкції”.</p>
                <p class="modal-text">Виробник товару несе персональну відповідальність, в межах Законодавства, про
                    достовірність інформації та дотримання  вимог використання даної торговельної марки передбачених
                    цим брендбуком. </p>
                <p class="modal-text">Суб'єктам господарювання незалежно від форми власності дозволяється
                    використовувати торговельну марку “Зроблено в Україні”, з дотриманням вимог даного брендбуку,
                    для створення графічних, відео чи аудіо матеріалів спрямованих на просування та популяризацію 
                    бренду “Зроблено в Україні”, а також використовувати графічні та відео матеріали Міністерства
                    економіки України розміщені на офіційному сайті програми <a href="https://madeinukraine.gov.ua/" target="_blank">https://madeinukraine.gov.ua/</a>
                </p>
            ...
            <form class="modal-form-block"><span class="modal-title">{{ trans('modal-download.btn-info') }}</span>
                <div class="modal-form-block-row">
                    <div class="input-wrap"><label class="input-label field-label">{{ trans('modal-download.input-pib') }}</label>
                        <div class="input-content"><input name="name" type="text" class="input" placeholder="{{ trans('modal-download.input-pib-placeholder') }}"
                                                          required></div>
                    </div>
                ...
                <div class="modal-form-block-submit-wrap"><a href="/" target="_blank"
                                                             class="btn  btn--blue modal-form-block-submit"><span
